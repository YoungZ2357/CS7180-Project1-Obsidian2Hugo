  ...
  return (
    <div style={containerStyle} className="p-4 sm:p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <span className="text-xs" style={{ color: "#5a5a7a" }}>v1.4 MVP</span>
      </div>
          ...
          <div className="space-y-6">
            ...
            {files.length > 0 && (
              <div className="space-y-2">
                ...
                <button
                  onClick={() => { setFiles([]); setExistingSite(null); setAutoFilledConfig(null); setDismissedWarnings(new Set()); setTopBannerDismissed(false); }}
